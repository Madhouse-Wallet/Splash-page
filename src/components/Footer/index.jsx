            ...
            <div className="col-span-12">
              <Wrpper className="flex items-center justify-center gap-2 flex-wrap">
                ...
                <ul className="social list-none pl-0 mb-0 flex items-center gap-2">
                  ...
                  <li className="py-1">
                    <Link
                      href={"https://www.tiktok.com/@madhousewallet"}
                      target="_blank"
                      style={{ height: 30, width: 30 }}
                      className=" text-xs hover:bg-primary bg-background-secondary rounded-circle flex items-center justify-center transition-all "
                    >
                  ...
                  <li className="py-1">
                    <Link
                      href={"https://www.instagram.com/madhouse.wallet"}
                      target="_blank"
                      style={{ height: 30, width: 30 }}
                      className=" text-xs hover:bg-primary bg-background-secondary rounded-circle flex items-center justify-center transition-all "
                    >
                  ...
                  <li className="py-1">
                    <Link
                      href={"https://www.linkedin.com/company/madhouse-wallet"}
                      target="_blank"
                      style={{ height: 30, width: 30 }}
                      className=" text-xs hover:bg-primary bg-background-secondary rounded-circle flex items-center justify-center transition-all "
                    >
...
const instagram = (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 2C9.284 2 8.944 2.012 7.877 2.06 6.813 2.108 6.087 2.278 5.45 2.525a5.507 5.507 0 0 0-1.99 1.296A5.507 5.507 0 0 0 2.165 5.81C1.917 6.448 1.747 7.175 1.7 8.238 1.653 9.306 1.64 9.645 1.64 12.36c0 2.716.012 3.055.06 4.122.048 1.063.218 1.79.465 2.427a5.507 5.507 0 0 0 1.296 1.99 5.507 5.507 0 0 0 1.989 1.297c.638.247 1.364.417 2.428.465 1.067.048 1.406.06 4.122.06s3.055-.012 4.122-.06c1.064-.048 1.79-.218 2.428-.465a5.507 5.507 0 0 0 1.99-1.297 5.507 5.507 0 0 0 1.296-1.99c.247-.637.417-1.364.465-2.427.048-1.067.06-1.406.06-4.122s-.012-3.054-.06-4.122c-.048-1.063-.218-1.79-.465-2.427a5.507 5.507 0 0 0-1.297-1.99 5.507 5.507 0 0 0-1.989-1.295c-.638-.247-1.365-.417-2.428-.465C15.055 2.012 14.716 2 12 2zm0 1.8c2.67 0 2.987.01 4.042.058.975.045 1.504.207 1.857.344.466.181.8.398 1.15.748.35.35.567.683.748 1.15.137.352.3.881.344 1.856.048 1.055.058 1.372.058 4.042s-.01 2.987-.058 4.042c-.045.975-.207 1.504-.344 1.857a3.1 3.1 0 0 1-.748 1.15 3.1 3.1 0 0 1-1.15.748c-.353.137-.882.3-1.857.344-1.055.048-1.372.058-4.042.058s-2.987-.01-4.042-.058c-.975-.045-1.504-.207-1.857-.344a3.1 3.1 0 0 1-1.15-.748 3.1 3.1 0 0 1-.748-1.15c-.137-.353-.3-.882-.344-1.857C3.811 14.987 3.8 14.67 3.8 12s.01-2.987.058-4.042c.045-.975.207-1.504.344-1.856a3.1 3.1 0 0 1 .748-1.15 3.1 3.1 0 0 1 1.15-.748c.353-.137.882-.3 1.857-.344C9.013 3.81 9.33 3.8 12 3.8zm0 3.065a5.135 5.135 0 1 0 0 10.27 5.135 5.135 0 0 0 0-10.27zm0 8.468a3.333 3.333 0 1 1 0-6.666 3.333 3.333 0 0 1 0 6.666zm5.338-8.671a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0z"
      fill="white"
    />
  </svg>
);
